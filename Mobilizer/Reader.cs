...
namespace System.Reflection.ILReader
		...
		class MetaData
			...
			class Table : IEnumerable
				...
				public Row this[int index]
					...
					//get { if (index >= rows.Length || rows[index] == null) Expand(index); return rows[index]; }
					}
	...
	public class Catch : ExceptionHandler
		...
		public Catch(Block tryBlock, Block handlerBlock, Type type) : base(tryBlock, handlerBlock)
			{
			this.type = type;	
			}
	...
	public class Fault : ExceptionHandler
		{
		public Fault(Block tryBlock, Block handlerBlock) : base(tryBlock, handlerBlock)
			{
			}
		}
	...
	public class Finally : ExceptionHandler
		{
		public Finally(Block tryBlock, Block handlerBlock) : base(tryBlock, handlerBlock)
			{
			}
		}
	...
	public class Filter : ExceptionHandler
		...
		public Filter(Block tryBlock, Block handlerBlock, int expression) : base(tryBlock, handlerBlock)
			{
	...
	public class ILReaderException : Exception
		{
		public ILReaderException(String message) : base(message)
			{
			}
		}
	}
